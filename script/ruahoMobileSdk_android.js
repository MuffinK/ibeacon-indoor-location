...
module.exports = [
   ...
   {
        "file": "plugins/com.ruaho.plugin/www/ruahoPlugin.js",
        "id": "com.ruaho.plugin",
        "clobbers": [
            "ruahoPlugin"
        ]
...
;cordova.define("com.ruaho.plugin", function(require, exports, module) {
  ...
  RuahoPlugin.showOrgAddressSection = function(paramObj, success, error) {
	...
	RuahoPlugin.fetchTreeSelect = function(paramObj, success, error) {
		exec(success, error, "RuahoPlugin", "fetchTreeSelect", [paramObj]);
	}
	...
	RuahoPlugin.displayWatermark = function(paramObj, success, error) {
		exec(success, error, "RuahoPlugin", "displayWatermark", [paramObj]);
	}

	RuahoPlugin.setLandscapeMode = function(paramObj, success, error) {
		exec(success, error, "RuahoPlugin", "setLandscapeMode", [paramObj]);
	}
	
	RuahoPlugin.displayContact = function(paramObj, success, error) {
		exec(success, error, "RuahoPlugin", "displayContact", [paramObj]);
	}
	...
	//通讯录搜索
	RuahoPlugin.searchContact = function(paramObj, success, error) {
		exec(success, error, "RuahoPlugin", "searchContact", [paramObj]);
	}
	
	//机构列表
	RuahoPlugin.showList = function(paramObj, success, error) {
		exec(success, error, "RuahoPlugin", "showList", [paramObj]);
	}
	
	//网络环境
	RuahoPlugin.getNetWorkStatusWIFI = function(paramObj, success, error) {
		exec(success, error, "RuahoPlugin", "getNetWorkStatusWIFI", [paramObj]);
	}
	
	//网络状态
	RuahoPlugin.getNetWorkStatus = function(paramObj, success, error) {
		exec(success, error, "RuahoPlugin", "getNetWorkStatus", [paramObj]);
	}
	
	RuahoPlugin.createNewActionList = function(paramObj, success, error) {
		exec(success, error, "RuahoPlugin", "fetchNewAction", [paramObj]);
	}

    RuahoPlugin.createSubAssigneeList = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "createSubAssigneeList", [paramObj]);
    }
    
    //日程书刷新
    RuahoPlugin.refreshCalendarData = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "refreshCalendarData", [paramObj]);
    }
    
    //第三方应用accessToken
    RuahoPlugin.getAccessToken = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "getAccessToken", [paramObj]);
    }
    ...
    //发送邮件下载
    RuahoPlugin.sendMail = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "sendMail", [paramObj]);
    }

    //获取当前用户手机位置
    RuahoPlugin.getPostion = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "getPostion", [paramObj]);
    }

    //二维码扫描
    RuahoPlugin.scanQRCodeICBC = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "scanQRCodeICBC", [paramObj]);
    }

    //ORC拍照构件js设计
    RuahoPlugin.ocrService = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "ocrService", [paramObj]);
    }

    //e服务影像构件
    RuahoPlugin.mediaManage = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "mediaManage", [paramObj]);
    }

    //支持跳转e服务存量功能
    RuahoPlugin.showOldBIOMItemPage = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "showOldBIOMItemPage", [paramObj]);
    }

    //机构切换后将当前机构信息保存客户端提供给存量功能
    RuahoPlugin.saveMBOStuId = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "saveMBOStuId", [paramObj]);
    }

    //支持法贷主页跳转信贷存量功能
    RuahoPlugin.showGCMSItemPage = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "showGCMSItemPage", [paramObj]);
    }

    //开启蓝牙信号扫码
    RuahoPlugin.startBleScan = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "startBleScan", [paramObj]);
    }

    //结束蓝牙信号扫码
    RuahoPlugin.endBleScan = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "endBleScan", [paramObj]);
    }

    //GCMS二维码扫描
    RuahoPlugin.openGCMSScan = function(paramObj, success, error) {
        exec(success, error, "RuahoPlugin", "openGCMSScan", [paramObj]);
    }
